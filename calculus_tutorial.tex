...
\clearpage
\input{sections/introduction1.tex}
% \input{sections/introduction2.tex}

\clearpage
\input{sections/math_prerequisites1.tex}
% \input{sections/math_prerequisites2.tex}


%  LIMITS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\input{sections/limits1.tex}
% \input{sections/limits2.tex}

%  DERIVATIVES  %%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\input{sections/derivatives.tex}


%  INTEGRALS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\input{sections/integrals.tex}
\input{sections/integrals_as_area_calculations.tex}
\input{sections/computing_integrals_numerically.tex}
\input{sections/integrals_as_functions.tex}
\input{sections/computing_integrals_symbolically.tex}
\input{sections/fundamental_theorem_of_calculus.tex}
\clearpage
\input{sections/techniques_of_integration.tex}
\input{sections/applications_of_integration.tex}


%  SEQUENCES & SERIES  %%%%%%%%%%%%%%%%%%%%%%
\clearpage
\input{sections/sequences_and_series.tex}



%  ADVANCED CALC  %%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\input{sections/multivariable_calculus.tex}
\input{sections/vector_calculus.tex}
...
\clearpage
\input{sections/from_sympy_tutorial.tex}
