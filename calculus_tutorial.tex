...
\title{{\Huge Calculus tutorial in 26 pages}}
...
\author{Key ideas from the \href{http://minireference.com/}{\textbf{No Bullshit Guide to Math and Physics}} by Ivan Savov} 
\date{\today}
