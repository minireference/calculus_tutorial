...
\hypersetup{breaklinks=true,
            ...
            pdftitle={Calculus explained in 23 pages},
            colorlinks=true,
            citecolor=blue,
            urlcolor=black,
            linkcolor=magenta,
...
\title{{\Huge Calculus explained in 23 pages}}
...
\author{Excerpt from the \href{http://minireference.com/}{\textbf{No Bullshit Guide to Math and Physics}} by Ivan Savov \vspace*{-6mm}} 
\date{\today}
...
\renewcommand*\l@subsection{\@dottedtocline{2}{1.6em}{2.2em}}
% If you also want to tighten subsection entries, uncomment and tune:
% \renewcommand*\l@subsection{\@dottedtocline{2}{1.6em}{2.0em}}
% \renewcommand*\l@subsubsection{\@dottedtocline{3}{3.6em}{2.6em}}
\makeatother
...
% Arabic numerals for sections and subsections
...
\begin{abstract}
	...
	that you need to know for science, engineering, and business use cases.
	We'll learn about limits, derivatives, integrals, sequences and series.
	This material is normally taught in two separated university courses:
	differential calculus and integral calculus,
	but we'll present both topics together
	so that we can highlight the connections between derivatives and integrals.
	We'll explain calculus concepts in multiple ways:
	using words, math formulas, visual explanations,
	and Python code examples.
	% both symbolic and numerical calculations.
\end{abstract}
...
%\vspace{4em}
\input{sections/00_learning_objectives.tex}

\vfill

\noindent
Visit \href{https://bit.ly/calctut3}{\tt{bit.ly/calctut3}}
to run the code examples from this tutorial in an interactive computational notebook.
	
\clearpage
\input{sections/10_introduction1.tex}
% \input{sections/introduction2.tex}

%\clearpage
\input{sections/20_math_prerequisites1.tex}
% \input{sections/math_prerequisites2.tex}
\bigskip	% LAYOUT
\bigskip	% LAYOUT
\input{sections/29_overview.tex}


%  LIMITS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\clearpage
\input{sections/30_limits1.tex}
% \input{sections/limits2.tex}

%  DERIVATIVES  %%%%%%%%%%%%%%%%%%%%%%%%%%%
%\clearpage
\input{sections/40_derivatives.tex}


%  INTEGRALS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\clearpage
\input{sections/50_integrals.tex}
\input{sections/51_integrals_as_area_calculations.tex}
\input{sections/52_computing_integrals_numerically1.tex}
\input{sections/53_integrals_as_functions.tex}
\input{sections/54_fundamental_theorem_of_calculus.tex}
\input{sections/55_techniques_of_integration.tex}
\input{sections/56_computing_integrals_numerically2.tex}
\input{sections/57_computing_integrals_symbolically.tex}
\input{sections/58_applications_of_integration.tex}


%  SEQUENCES & SERIES  %%%%%%%%%%%%%%%%%%%%%%
%\clearpage
\input{sections/60_sequences_and_series.tex}



%  ADVANCED CALC  %%%%%%%%%%%%%%%%%%%%%%%%%
%\clearpage
\input{sections/70_advanced_calculus.tex}
% CUT because not adding that much value + scary 
%\input{sections/70_multivariable_calculus.tex}
%\clearpage
%\input{sections/80_vector_calculus.tex}
% /CUT because not adding that much value + scary
...
\vfill
	...
	for further calculus explanations and more practice problems.
	

	\begin{wrapfigure}[11]{r}{0pt}
	\includegraphics[width=118pt]{figures/cover_v40_noline_lighter.jpg}
	%\includegraphics[width=125pt]{/Library/WebServer/Documents/miniref/data/media/physics/mass_spring-highres.png}
	\end{wrapfigure}

	This book contains short lessons
