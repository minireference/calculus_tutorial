...
\input{sections/52_computing_integrals_numerically.tex}
\input{sections/53_integrals_as_functions.tex}
\input{sections/54_computing_integrals_symbolically.tex}
\input{sections/55_fundamental_theorem_of_calculus.tex}
\clearpage
\input{sections/56_techniques_of_integration.tex}
\input{sections/57_applications_of_integration.tex}
