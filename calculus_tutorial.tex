...
\begin{abstract}
	...
	that you need to know for science, engineering, and business.
	...
	using words, math formulas, graphs,
	and also show Python code examples.
	% both symbolic and numerical calculations.

	Visit \href{https://bit.ly/calctut3}{\tt{bit.ly/calctut3}}
	to follow along in an interactive notebook.
\end{abstract}
