...
\begin{abstract}
This tutorial summarizes the key ideas of calculus using math formulas,
visual intuition, and Python code examples.

Click this link to view the tutorial online: \href{https://bit.ly/calctut3}{\tt{bit.ly/calctut3}}\,.
\end{abstract}
