...
\label{sec:derivatives}
	...
	Let's start by calculating the \emph{average} slope of the function between two points.
	...
	When $\Delta x = 0.3$ the slope is $m = \frac{\Delta y}{\Delta x} = \frac{0.69}{0.3} = 2.3$.
	...
	but goes to zero.
	In words,
	this derivative formula describes the rise-over-run calculation
	...
	\subsection{Numerical derivative calculations}
		...
		will be an approximation to the true derivative.
	...
	\subsection{Derivative formulas}
		...
		Table~\ref{table:derivatives} shows the derivatives of several functions.
	...
	\subsection{Examples}
		...
		you can find the derivative of any function,
...
%		which deserves its own section!
	...
	\label{derivatives:optimization}
		...
		\subsubsection{Numerical optimization}
			...
			and an initial value $x_0$ where to start the minimization process.
