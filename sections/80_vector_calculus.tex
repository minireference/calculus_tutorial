...
\section{Vector calculus}
	...
	\subsection{Path integrals}
		...
		Vector path integral. 
			...
			we take the dot product with $d\mathbf{r}  \equiv \mathbf{r}'(t) dt$ during each step.
	...
	\subsection{Surface integrals}
		...
		Vector surface integral. 
			...
			we take the dot product with $d\mathbf{S}  \equiv \hat{\mathbf{n}}dS \equiv (\mathbf{r}_u^\prime \times \mathbf{r}_v^\prime) dudv$,
	...
	\subsection{Vector calculus theorems}
		...
		%which states the integral of the divergence $\textrm{div}(\vec{F}) \equiv \nabla \cdot \vec{F}$ 
