...
\section{Introduction}
	...
	\label{introduction:car_example}
		...
		which we'll call $t=0$,
		you reset the trip odometer so it reads $x(0)=0$~m.
	...
	shows that calculus concepts are not theoretical constructs reserved only for math specialists,
