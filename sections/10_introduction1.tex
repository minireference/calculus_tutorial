...
\section{Introduction}
	...
	Calculus studies the properties of functions.
	We use calculus concepts
	to describe various quantities in physics, chemistry, biology, engineering, business,
...
% MAYBE MOVE TO MATH PREREQUISITES
	\subsection{Infinity}
	
		The math symbol $\infty$ describes the concept of \emph{infinity}.
		Infinity is the key building block for calculus,
		so it's important that you develop the right way to think about this concept.
		...
		Indeed,
		calculus can be described as the ``infinity upgrade'' to the high school math
...
% /REPEATS
		Calculus operation also appear in probability, statistics, and machine learning.
		%
		In all this areas,
...
so you can think more clearly about these types of problems.
...
% - explain why we need + how we use in class, self-study, industry
	...
	\subsection{Doing calculus}
		...
		Let's describe what doing calculus looks like.
		...
		\subsubsection{Symbolic calculations using pen and paper}
			...
			The pen-and-paper approach continues to be the best way to learn about derivatives and integrals even to this day.
			%
		...
		\subsubsection{Symbolic calculations using SymPy}
			...
			We're not in the \textsuperscript{th} century
...
%	similar to the calculation you could do using pen and paper.
			...
			allows us to do symbolic math calculations very much faster than we could do on paper.
			To use SymPy,
