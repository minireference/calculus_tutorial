%!TEX root = ../calculus_tutorial.tex
	...
	\label{integrals:computing_integrals_numerically}
		...
		we can clearly see that the area computed in this way is an underestimate
		to the true area under the graph.
		...
		\subsubsection{Example 3 continued}
			...
			$\frac{16}{3} = 5\frac{1}{3} = 5.\overline{3} = 5.3333333333\ldots$.
