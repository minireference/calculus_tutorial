%!TEX root = ../calculus_tutorial.tex
	...
	\label{integrals:computing_integrals_numerically}
		...
		knowing that the ``quality'' of the approximations
		will improve when we split the region into thinner and thinner strips.
		...
		We'll now this math formula into a Python procedure
		...
		$\tt{xs} = [a + \Delta x, a + 2\Delta x, a + 3\Delta x, \ldots, n\Delta x]$,
		and evaluate the function \tt{f} at these $x$-values
		to obtain $\tt{fxs} = [f(a + \Delta x), f(a + 2\Delta x), f(a + 3\Delta x), \ldots, f(n\Delta x)]$.
