%!TEX root = ../calculus_tutorial.tex
	...
	\label{integrals:computing_integrals_numerically}
		...
		and we sum together all of them to compute the approximation to the total area:
		\[ 
			A_h(0,2)
			\approx
			h(0.2) \cdot 0.2
		...
		\[
			...
			\Delta x = \tfrac{b-a}{n}.
		\]
		This is known as the \emph{Riemann sum} formula for computing areas.
		We'll now turn this math formula into a Python procedure
	...
	% Formal definition of the integral as the limit of a Riemann sum
		...
		are essential tools that allow us to perform these calculus operations on functions.
