...
TODO: Explain
		...
		\subsubsection{Other tricks}
			...
			There is an entire integral calculus course dedicated to learning integration tricks,
			which are important to know primarily for physicists and engineers.
