%!TEX root = ../calculus_tutorial.tex
	...
	\subsection{Computing integrals functions using SymPy}
		...
		\subsubsection{Example 11S: Constant function}
			...
			to specify the variable of integration
		...
		\subsubsection{Example 13S: Polynomial function}
			...
			\noindent
			We can now make SymPy compute the integral function $H_0(b) = \int_0^b h(x)\,dx$
			by calling \tt{sp.integrate}:
