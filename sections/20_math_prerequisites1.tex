...
\section{Math prerequisites}
	...
	\subsection{Set notation}
		...
		\subsubsection{Infinity}
			...
			you can imagine the number line extends to the right forever towards infinity,
	...
	\subsection{Inventory of functions}
		...
		but if you're familiar with the six function shown in Figure~\ref{fig:panel_function_graphs1},
	...
	\subsection{Trigonometric functions}
		...
		and $\cos\theta$ and $\sin\theta$ are the trigonometric functions.
