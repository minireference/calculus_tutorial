...
\section*{Overview and a look ahead}
	...
	Limits give us a precise language for talking about infinity.
	% ALT: talk about infinitely large and infinitely small quantities
	Limits are a cornerstone idea in calculus,
	because they allow us to define the three calculus operations:
	...
	We'll conclude with practice problems
	and links to calculus learning resources.
	% a brief intro to multivariable calculus in Section~\ref{sec:multivariable_calculus}.
