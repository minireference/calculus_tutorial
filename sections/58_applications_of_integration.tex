%!TEX root = ../calculus_tutorial.tex
	...
	\subsection{Applications of integration}
		...
		\subsubsection{Solving differential equations}
			...
			A differential equation specifies an unknown function $f(t)$
			in terms of its derivatives $f^{\prime\!}(t)$, $f^{\prime\prime\!}(t)$, etc.
			...
			you'll learn all kinds of tricks and techniques for solving differential equations.
		...
		\subsubsection{Probability and expectation calculations}
			...
			we must integrate the probability density $f_X$ from $x=a$ to $x=b$:
			\[
				\Pr( \{ a \leq X \leq b\} )
			...
			\ifthenelse{\boolean{FORSTATSBOOK}}{
				...
				by the corresponding value of the probability density at $x$,
				...
				so it's good if you know a thing or two about integrals.
			}{
