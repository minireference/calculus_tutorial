...
We use our knowledge of $a(t)$ and the initial velocity $v_i$ to obtain $v(t)$.
			...
			%	Consider an object of mass $m$ that has a constant net $\vec{F}_{\textrm{net}}$
			...
			but if you know calculus you know where it comes from:
		...
		\subsubsection{Solving differential equations}
			...
			that specify unknown function $f(t)$ in terms of their derivatives $f^{\prime\!}(t)$, $f^{\prime\prime\!}(t)$, etc.
			...
			\begin{itemize}
				...
				\item	The kinematics equations when the acceleration is constant
					come front he differential equation $x^{\prime\prime\!}(t) = a$.
					...
					by computing the the second derivative of $x(t)$.
				...
				\item In biology,
					...
					The solution to this equation is $b(t) = b_0e^{\lambda t}$,
		...
		% ALT. Probability and expectation calculations
			...
			we evaluate the integral $\int_{-1}^1 f_Z(z) \, dz$,
