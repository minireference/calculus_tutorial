...
% TODO: procedure
	...
	\label{limits:limits_to_zero}
		...
		The limit expression $\lim_{x \to 0} f(\delta)$
...
Let's use SymPy to revisit some of the limit calculations we saw above.
...
which is a clever name since it resembles the infinity symbol $\infty$.
		...
		then using \tt{sp.limit} to evaluate the limit
