...
\label{sec:limits}
	...
	for talking about infinitely large numbers,
...
%			(see \href{http://bit.ly/1jGU1Kz}{\texttt{bit.ly/1jGU1Kz}}).
	...
	\label{limits:continuity}
		...
		Geometrically,
		the graph of the function at $x=a$ is ``smooth'' and
		doesn't make a sudden jump at $x=a$.
		Intuitively,
		when a function is continuous,
		we can draw its graph using a single stroke without lifting the pen.
		...
		\subsubsection{Example 3}
			...
			\noindent
			The Heaviside function is zero for negative values of $x$,
