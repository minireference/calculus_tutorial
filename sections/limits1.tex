...
%			(see \href{http://bit.ly/1jGU1Kz}{\texttt{bit.ly/1jGU1Kz}}).
	...
	\label{limits:limits_to_infinity}
		...
		\begin{figure}[htb]
			\centering
			\includegraphics[width=0.25\textwidth]{figures/calculus/limit-at-infinity-graph.png}
			\vspace{-3mm}
...
% /SHORTEN
	...
	\subsection{Applications of limits}
		...
		\label{limits:limits_for_integrals}
			...
			\[ 
				A(a,b) \approx \underbrace{ \Delta x f(a)
									\!+\! \Delta x f(a+\Delta x) 
			  						% \!+\! \Delta x f(a+2\Delta x) + \cdots 
									\!+\! \Delta x f(b-\Delta x)}_{n \textrm{ terms}}.
			\]
