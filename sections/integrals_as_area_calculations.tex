...
\subsection{Integrals as area calculations}
	...
	\subsubsection{Example 1: integral of a constant function}
		...
		\begin{figure}[htb]
			\centering
			\includegraphics[width=0.5\textwidth]{figures/calculus/simple_integral_fx_eq_3.pdf}
	...
	\subsubsection{Example 2: integral of a linear function}
		...
		\begin{figure}[htb]
			\centering
			\includegraphics[width=0.5\textwidth]{figures/calculus/simple_integral_gx_eq_x.pdf}
