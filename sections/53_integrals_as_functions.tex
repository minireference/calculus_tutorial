%!TEX root = ../calculus_tutorial.tex
	...
	\subsection{Act 2: Integrals as functions}
		...
		we denote the integral function using the capitalized letter used to denote the original function.
...
% MAYBE: mention ALT. name ``area accumulation function'' 
	...
	\subsection{Intermission}
		...
		I think you should stay though---you might enjoy the \emph{knowledge buzz} moment
		when you learn about the fundamental theorem of calculus,
		which is coming next.
		%  in the next few pages
		My calculus teacher in college
		described the realization you get after understanding this theorem
