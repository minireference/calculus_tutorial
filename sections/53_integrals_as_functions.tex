...
%we're forced to do the split-into-vertical-strips --- i.e. there is no analytical shortcut.
	...
	\subsection{Intermission}
		...
		My college calculus professor in college
		described the realization you get after understanding the FTC
		as similar to the feeling you you get smoke some of that funny stuff.
...
%	Differentiation is the inverse operation of integration.
		...
		%		
		% (M6)
		With your consent we continue with the integrals,
		else skip ahead to Section~\ref{integrals:scipy}
		for some tech talk about high performance numerical integrals,
		or straight away to Section~\ref{sec:sequences_and_series} to learn about sequences and series,
