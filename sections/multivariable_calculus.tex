...
\section{Multivariable calculus}
	...
	\subsection{Plotting multivariable functions}
		...
		\begin{figure}[htb]
			\centering
			% TODO: redo using plt
			\includegraphics[width=0.63212\columnwidth]{figures/calculus/multivariable_caclulus_3d_surface_plot.pdf}
			\vspace{-2mm}
		...
		\begin{figure}[htb]
			...
			\includegraphics[width=0.63212\columnwidth]{figures/calculus/multivariable_caclulus_topographic_map.png}
			\vspace{-4mm}
