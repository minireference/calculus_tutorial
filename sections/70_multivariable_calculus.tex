...
\section{Multivariable calculus}
	...
	to functions with multiple inputs variables.
	...
	\subsection{Multivariable functions}
		...
		% EXAMPLE FUNCTION
		Consider the function bivariate function $f(x,y) = 4 - x^2 - \frac{1}{4}y^2$.
		...
		\begin{figure}[htb]
			...
			\vspace{-2mm}
			\caption{The 3D surface plot of the the function $f(x,y) = 4 - x^2 - \frac{1}{4}y^2$.}
	...
	\subsection{The gradient operator}
		...
		\subsubsection{Example}
			...
			Try to identify the point with coordiantes $(0,-4)$
			in figures \ref{fig:mulivar_surface_plot_paraboloid} 
			and \ref{fig:mulivar_countour_plot_paraboloid}
			and confirm that the ``uphill'' direction at hat point is indeed in the positive $y$-direction.
	...
	\subsection{Double integrals}
		...
		and compute the total volume of a many rectangular columns
	...
	\subsection{Applications of multivariable calculus}
		...
		but repeatedly taking steps in the ``downhill'' direction,
		...
		There is a lot more to learn about derivatives and integral of multivariable functions,
		which haven't even have time to mention here.
		Your basic knowledge of derivatives and integrals concepts we discussed
		earlier in this tutorial will be very useful for understanding these more advanced topics.
