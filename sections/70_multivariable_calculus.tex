...
\section{Multivariable calculus}
	...
	\subsection{Plotting multivariable functions}
		...
		and graph the function $f(x,y)$ is as a surface in 3D as illustrated in Figure~\ref{fig:mulivar_surface_plot_paraboloid}.
		...
		\noindent
		The curve labeled 30m line you see in Figure~\ref{fig:mulivar_countour_plot_paraboloid} represents
