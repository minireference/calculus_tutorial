...
\section{Vector calculus}
	...
	\subsection{Example: electric field around a positive charge}
		...
		$r \eqdef \sqrt{x^2+y^2+z^2}$ is the distance from the origin,
	...
	\subsection{Vector calculus integrals}
		...
		There are different kinds of integral operations you can use with vector fields,
